...
const FeatureContents = () => (
  <Container text>
    ...
    <ul>
      <li>
        Selectable processing functions, each built for a specific purpose or
        demonstration.
      </li>
      <li>
        Reads and writes a wide range of file formats, including lossless format
        such as <em>flac</em>
      </li>
    ...
    <p>
      This tool exists because a simple platform for testing and experimenting
      audio processing was needed. When working with audio systems it is great
      to showcase or test a specific effect, e.g. the Quantizer which shows the
      practical audible effects of quantization. When working with system
      installations, the tool can be used for aiding the setup process. E.g. the
      Panner can be used to pan audio to the rear channels in a multi-channel
      setup to test setup consistency.
    </p>
